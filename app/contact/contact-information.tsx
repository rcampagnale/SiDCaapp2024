    ...
    <View style={{ height: "100%", paddingTop: statusBarHeight }}>
      <View style={styles.container}>
        ...
        <View style={styles.mediasContactContainer}>
          ...
          >
            <Text style={{ fontSize: 18 }}>Departamento Jurídico</Text>
            <Image
              style={{ width: 30, height: 30 }}
              source={require("../../assets/logos/whatsapp.png")}
            />
          ...
          >
            <Text style={{ fontSize: 18 }}>SiDCa Gestión Expediente</Text>
            <Image
              style={{ width: 30, height: 30 }}
              source={require("../../assets/logos/whatsapp.png")}
            />
          ...
          >
            <Text style={{ fontSize: 18 }}>Secretaría de Capacitación</Text>
            <Image
              style={{ width: 30, height: 30 }}
              source={require("../../assets/logos/whatsapp.png")}
            />
